...
package com.xatu.yuexin.util.bluetooth;
...
import com.xatu.yuexin.welding4sl.activity.BluetoothChatActivity;
...
public class BluetoothChatService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothChatActivity.TOAST, "无法连接装置");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothChatActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothChatActivity.TOAST, "装置连接丢失");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
//                            .sendToTarget();
                    ...
                    msg.what = BluetoothChatActivity.MESSAGE_READ;  
                    msg.setData(data);  
                    mHandler.sendMessage(msg); 
                } catch (IOException e) {
