...
public class UtilTool {
     ...
     * @param cellInfos
     * @return*/public static String getRequestParams(List<CellInfo> cellInfos){
     ...
     * UTC + 时区差 ＝ 本地时间(北京为东八区)
     *
     * @return*/public static long getUTCTime() {
        //取得本地时间
     ...
     *
     * @return*/public static ArrayList<CellInfo> init(Context ctx) {
